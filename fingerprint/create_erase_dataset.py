...
def main(args):
    ...
    for _ in range(args.num_samples):
        ...
        train_dataset["type"].append("erase")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_samples', type=int, default=128, required=True, help='Number of samples in dataset.')
   
    parser.add_argument('--x_length_min', type=int, default=9, required=False, help='Minimum length of x')
