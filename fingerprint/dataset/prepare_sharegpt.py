...
if not os.path.exists("stanford_alpaca/sharegpt_data.json"):
    print("Processing ShareGPT data")
    cleaned_sharegpt_file = "stanford_alpaca/sharegpt_cleaned.json"
    ...
    print("Using existing data file at stanford_alpaca/sharegpt_data.json")